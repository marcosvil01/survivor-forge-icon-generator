...
const PRESETS: { id: string; label: string; desc: string; icon: string; template: Partial<ServerTemplate> }[] = [
  {
    ...
    template: {
      ...
      categories: [
        cat("INFORMACIÓN", "📋", [
          ch("welcome", "text", "🏆", "Canal de bienvenida automática"),
          ch("rules", "rules", "📜", "Reglas del servidor — léelas obligatoriamente"),
          ch("server-faq", "text", "❓", "Preguntas frecuentes del servidor"),
          ch("whitelist", "text", "📋", "Sistema de whitelist"),
          ch("announcements", "announcement", "📢", "Anuncios oficiales del staff"),
          ch("change-logs", "text", "😡", "Registro de cambios y actualizaciones"),
          ch("sneak-peaks", "text", "👀", "Avances de lo que viene"),
        ]),
        cat("SOPORTE", "🎫", [
          ch("ticket-creation", "text", "🎫", "Crea tu ticket de soporte aquí"),
          ch("faq-soporte", "text", "📖", "Preguntas frecuentes de soporte"),
        ]),
        cat("COMUNIDAD", "💬", [
          ch("non-wl-chat", "text", "💬", "Chat para no-whitelisteados"),
        ...
        cat("IC-AREA", "📌", [
          ch("camp-pinboard", "text", "📌", "Tablón de anuncios del campamento"),
          ch("radio-ic", "text", "📻", "Comunicaciones in-character"),
          ch("notas-ic", "text", "📝", "Notas y mensajes IC"),
        ]),
        cat("VOZ", "🔊", [
      ...
      roles: [
        // ─── STAFF ───
        { id: uid(), name: "👑 Founder", color: "#ff4444", hoist: true, mentionable: false, permissions: ["ADMINISTRATOR"] },
        { id: uid(), name: "🔧 Developer", color: "#e91e63", hoist: true, mentionable: false, permissions: ["ADMINISTRATOR"] },
        { id: uid(), name: "🎮 Game Master", color: "#9b59b6", hoist: true, mentionable: false, permissions: ["MANAGE_GUILD", "MANAGE_ROLES", "MANAGE_CHANNELS", "KICK_MEMBERS", "BAN_MEMBERS", "MANAGE_MESSAGES", "MUTE_MEMBERS", "MOVE_MEMBERS", "MANAGE_NICKNAMES", "MENTION_EVERYONE", "VIEW_AUDIT_LOG"] },
        { id: uid(), name: "⚡ Super Admin", color: "#e74c3c", hoist: true, mentionable: false, permissions: ["ADMINISTRATOR"] },
        { id: uid(), name: "🛡️ Admin", color: "#e67e22", hoist: true, mentionable: false, permissions: ["ADMINISTRATOR"] },
        { id: uid(), name: "⭐ Senior Mod", color: "#f1c40f", hoist: true, mentionable: true, permissions: ["MANAGE_MESSAGES", "KICK_MEMBERS", "BAN_MEMBERS", "MUTE_MEMBERS", "MOVE_MEMBERS", "MANAGE_NICKNAMES", "VIEW_AUDIT_LOG"] },
        { id: uid(), name: "⚔️ Moderador", color: "#2ecc71", hoist: true, mentionable: true, permissions: ["MANAGE_MESSAGES", "KICK_MEMBERS", "MUTE_MEMBERS", "MOVE_MEMBERS"] },
        { id: uid(), name: "🎧 Soporte", color: "#3498db", hoist: true, mentionable: true, permissions: ["MANAGE_MESSAGES", "MUTE_MEMBERS"] },
        { id: uid(), name: "📝 Trial Mod", color: "#1abc9c", hoist: true, mentionable: true, permissions: ["MANAGE_MESSAGES"] },
        // ─── SPECIAL ───
        { id: uid(), name: "🤖 Bots", color: "#7289da", hoist: true, mentionable: false, permissions: ["MANAGE_MESSAGES", "MANAGE_ROLES"] },
        { id: uid(), name: "🚀 Booster", color: "#f47fff", hoist: true, mentionable: false, permissions: [] },
        // ─── RANGOS SUPERVIVIENTE ───
        { id: uid(), name: "🏆 Leyenda", color: "#ffd700", hoist: true, mentionable: true, permissions: [] },
        { id: uid(), name: "💀 Veterano", color: "#ff6b6b", hoist: true, mentionable: true, permissions: [] },
        { id: uid(), name: "🔥 Élite", color: "#ff9500", hoist: true, mentionable: true, permissions: [] },
        { id: uid(), name: "🧟 Superviviente", color: "#f39c12", hoist: true, mentionable: true, permissions: [] },
        { id: uid(), name: "🌿 Explorador", color: "#2ecc71", hoist: false, mentionable: true, permissions: [] },
        { id: uid(), name: "👤 Novato", color: "#95a5a6", hoist: false, mentionable: false, permissions: [] },
        // ─── FACCIONES ───
        ...
        // ─── ESTADO ───
        { id: uid(), name: "✅ Verificado", color: "#43b581", hoist: false, mentionable: false, permissions: [] },
